...
import { header } from './scriptUtils'
...
async function run(): Promise<${returnType === undefined ? 'void' : returnType}> {
    ...
    console.log('Task Parameters: \${JSON.stringify(taskParameters, undefined, 4)}')
...
`
    ...
    const output = fileHeader + importStament + runStatement + run
